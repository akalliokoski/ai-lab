...
TARGET_DATASET = "artifact-card-failure-modes-forced-top2-v2p1"
SUPPLEMENTAL_CASES_PATH = DATA_ROOT / "artifact-card-failure-modes-forced-top2-v2p1" / "supplemental_train_cases.json"
...
def build_input(metadata: dict[str, str], summary: str, evidence_lines: list[str]) -> str:
    ...
    return (
        ...
        + "- Evidence-key compatibility reminders: generic-explanation -> broader-than-reference; missing-required-detail -> missing-or-noncanonical-field; fluency-without-correctness -> fluency-gain-without-correctness.\n"
