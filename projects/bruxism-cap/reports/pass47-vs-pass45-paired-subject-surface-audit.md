# Subject-score comparison — pass47-repaired-a3-control-expanded vs pass45-repaired-a3-no-shape
...
|---|---|---:|---:|---:|---:|---:|---|---|
| brux1 | bruxism | 0.669 | 0.641 | +0.028 | 0.700 | 0.700 | bruxism | bruxism |
| brux2 | bruxism | 0.212 | 0.178 | +0.034 | 0.000 | 0.000 | control | control |
| n11 | control | 0.283 | 0.345 | -0.062 | 0.200 | 0.300 | control | control |
| n3 | control | 0.081 | 0.134 | -0.053 | 0.000 | 0.100 | control | control |
| n5 | control | 0.334 | 0.337 | -0.003 | 0.300 | 0.200 | control | control |
...
- Margin delta (primary-anchor): `+0.039`.
...
- `{'bruxism': {'mean_primary_score': 0.44044163649111234, 'mean_anchor_score': 0.40944111481933193, 'mean_score_delta_primary_minus_anchor': 0.031000521671780412}, 'control': {'mean_primary_score': 0.23280946476481293, 'mean_anchor_score': 0.2721714344746094, 'mean_score_delta_primary_minus_anchor': -0.03936196970979649}}`
