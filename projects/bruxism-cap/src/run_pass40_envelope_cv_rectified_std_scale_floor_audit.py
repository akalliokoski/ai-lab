...
PASS_NUMBER = 40
TARGET_FEATURES = ["envelope_cv", "rectified_std"]
Q90_MULTIPLIER = 0.5
SUBJECT_IDS = ["brux1", "brux2", "n3", "n5", "n11"]
PRIMARY_OFFENDER = "rectified_std"
ALTERNATE_OFFENDER = "mean"
...
- Pass39 feature table: `projects/bruxism-cap/data/window_features_pass40_emg_s2_mcap_a1_only_pct10_90_timepos10_record_relative_shape_envcv_rectstd_floor.csv`
...
def main() -> None:
    ...
    pass39_features = data_dir / "window_features_pass40_emg_s2_mcap_a1_only_pct10_90_timepos10_record_relative_shape_envcv_rectstd_floor.csv"
    pass39_report_path = reports_dir / "loso-cv-pass40-emg-a1-pct10-90-record-relative-shape-envcv-rectstd-floor.json"
    summary_json_path = reports_dir / "pass40-envelope-cv-rectified-std-scale-floor-audit.json"
    summary_md_path = reports_dir / "pass40-envelope-cv-rectified-std-scale-floor-audit.md"
